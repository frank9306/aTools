...
const translations: Record<Language, Record<string, string>> = {
    en: {
        ...
        "automation.add_task": "Add Task",
        "automation.no_tasks": "No automation tasks defined.",
        "automation.name": "Task Name",
        "automation.cron": "Cron Expression",
        "automation.command": "Command",
        "automation.actions": "Actions",
        "automation.last_run": "Last Run",
        "automation.result": "Last Result",
        "automation.run_now": "RUN NOW",
        "automation.save": "Save Task",
        "automation.cancel": "Cancel",
        "automation.enabled": "Enabled",
        "automation.stop": "Kill Process",
        "automation.placeholder_name": "My Daily Backup",
        "automation.placeholder_cron": "0 30 9 * * * (At 09:30:00am or @daily)",
        "automation.placeholder_cmd": "echo 'Hello World' > log.txt",
    },
    zh: {
        "nav.processes": "系统进程",
        "nav.devtools": "开发者工具",
        ...
        "automation.add_task": "新建任务",
        "automation.no_tasks": "暂无自动化任务",
        "automation.name": "任务名称",
        "automation.cron": "Cron 表达式",
        "automation.command": "执行命令",
        "automation.actions": "操作",
        "automation.last_run": "上次运行",
        "automation.result": "运行结果",
        "automation.run_now": "立即运行",
        "automation.save": "保存任务",
        "automation.cancel": "取消",
        "automation.enabled": "启用",
        "automation.stop": "停止任务",
        "automation.placeholder_name": "每日备份",
        "automation.placeholder_cron": "0 30 9 * * * (每天 09:30:00)",
        "automation.placeholder_cmd": "echo 'Hello' > log.txt",
    }
};
